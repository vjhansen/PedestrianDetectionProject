...
void loop() {
  // put your main code here, to run repeatedly:
     ...
     //kjør dette en gang, bruk funksjoner til å gi instrukser
     if(y <=  0){
      opp(8, 100);
      venstre(150, 100);
      delay(5000);
...
//vi skal vri, den andre for hvor fort (større gir saktere
//pga delay blir større)
